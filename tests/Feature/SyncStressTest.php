...
// Crear 1000 órdenes con cambios pendientes
$orders = [];
for ($i = 1; $i <= 1000; $i++) {
$order = Order::create([
'company_id' => $this->company->id,
...
// Verificar que hay 1000 items pendientes
...
'total' => 5950,
    ...
    // Crear entrada en sync_queue (simula creación offline)
    SyncQueue::create([
        'company_id' => $this->company->id,
        'branch_id' => $this->branch->id,
        'entity_type' => Order::class,
        ...
        'status' => 'pending',
        'attempts' => 0,
        'created_at' => now()->subMinutes(60 - $i), // Creación escalonada
    ]);
...
// Simular reinicio del cliente
// (En realidad, los 10 procesados ya fueron eliminados de sync_queue)
