...
class CashCountResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'reason' => $this->reason,
            'expected_amount' => is_numeric($this->expected_amount) ? (int) $this->expected_amount : 0,
            'counted_amount' => is_numeric($this->counted_amount) ? (int) $this->counted_amount : 0,
            'difference' => is_numeric($this->difference) ? (int) $this->difference : 0,
